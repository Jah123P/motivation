...
class SelfCareQuotesScreen extends StatefulWidget {
  final List<String> selfCareQuotes;
  final List<String> favoritedQuotes;
  final Function(String) onFavoriteToggle;

  SelfCareQuotesScreen({
    required this.selfCareQuotes,
    required this.favoritedQuotes,
    required this.onFavoriteToggle,
  });

  @override
  _SelfCareQuotesScreenState createState() => _SelfCareQuotesScreenState();
}

class _SelfCareQuotesScreenState extends State<SelfCareQuotesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Self-care Quotes', style: TextStyle(color: Colors.white)),
        centerTitle: true,
        leading: IconButton(
      ...
      body: Padding(
        ...
        child: widget.selfCareQuotes.isEmpty
            ? Center(
          child: Text(
            'No quotes available',
          ...
          itemCount: widget.selfCareQuotes.length,
          itemBuilder: (context, index) {
            final quote = widget.selfCareQuotes[index];
