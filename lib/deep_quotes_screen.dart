...
class DeepQuotesScreen extends StatefulWidget {
  ...
  DeepQuotesScreen({
    required this.deepQuotes,
    required this.favoritedQuotes,
    required this.onFavoriteToggle,
  });

  @override
  _DeepQuotesScreenState createState() => _DeepQuotesScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Deep Quotes', style: TextStyle(color: Colors.white)),
        centerTitle: true,
        leading: IconButton(
      ...
      body: Padding(
        ...
        child: widget.deepQuotes.isEmpty
            ? Center(
          child: Text(
            'No quotes available',
          ...
          itemCount: widget.deepQuotes.length,
          itemBuilder: (context, index) {
            final quote = widget.deepQuotes[index];
